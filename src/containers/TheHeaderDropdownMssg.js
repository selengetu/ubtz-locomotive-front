    ...
    >
      ...
      <CDropdownMenu className="pt-0" placement="bottom-end">
        <CDropdownItem
          ...
          color="light"
        >
          <strong>Таньд нийт {itemsCount} захидал ирсэн байна</strong>
        </CDropdownItem>
        <CDropdownItem href="#">
        ...
        <CDropdownItem href="#" className="text-center border-top"><strong>Бүх захидлыг харах</strong></CDropdownItem>
      </CDropdownMenu>
    </CDropdown>
  )
}
